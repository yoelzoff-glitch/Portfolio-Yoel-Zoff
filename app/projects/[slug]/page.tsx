...
const libretaxProject: DetailedProject = {
  ...
  images: [
    { url: "/images/libretax-portada.png", caption: "Logo Oficial de LibretaX: Plataforma SaaS para Vendedores de Mercado Libre." },
    { url: "/images/libretax-dashboard.png", caption: "Dashboard Principal: KPIs en tiempo real (Facturación bruta, Bolsillo Limpio, margen consolidado, alertas de stock crítico y top de productos)." },
    { url: "/images/libretax-finanzas.png", caption: "Finanzas y P&L: Estado de resultados completo con comisiones ML discriminadas, costos de envío bonificados, CMV e impuestos." }
  ],
  ...
  demoUrl: "https://www.libretax.com.ar",
